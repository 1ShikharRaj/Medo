...
import { Plus, Users, Search, User as UserIcon } from 'lucide-react';
      ...
      <Card className="border-slate-200">
        <div className="p-4 border-b bg-slate-50 flex items-center gap-4">
          <div className="relative flex-1 max-w-md">
            ...
            <Input className="pl-9 bg-white" placeholder="Search patients by name or ID..." />
          </div>
        </div>
              ...
              patients.map((p: any) => (
                <div key={p._id.toString()} className="p-4 hover:bg-slate-50 transition-colors flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Button variant="outline" size="sm" className="hidden" disabled>View Details</Button>
                  </div>
                </div>
              ))
            )}
